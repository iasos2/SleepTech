...
// === 자바 배열 (정적) ===
	// : 한 번 생성되면 크기 변경 X
	// : 크기 변경이 필요한 경우, 변경된 크기의 배열을 생서하여 요소값을 복사
public class E_Array {

	public static void main(String[] args) {
		int[] numbers = new int[5];
		System.out.println(Arrays.toString(numbers)); // [0, 0, 0, 0, 0]
		// System.out.println(numbers[5]); // java.lang.ArrayIndexOutOfBoundsException
		
		// === 동적 배열(ArraysList) 사용법 ===
		...
		// +) Collection Framework의 모든 클래스 내부에서는 객체 구조만을 다움
		// 		: 기본 타입 사용 X
		...
		// - 정적 배열은 크기값 미지정 시 오류
		// - 크기를 명시적으로 전달하지 않는 경우 실제 요소값이라도 전달
