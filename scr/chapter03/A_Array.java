...
public class A_Array { // 클래스 명 == 파일 명 (대문자로 시작)
	...
	public static void main(String[] args) {
		...
		// - 데이터를 연속적으로 저장
		// - 각각의 순서 지정 (index 인덱스 번호, 0부터 1씩 증가되는 값)
		...
		System.out.println(scores[1]);
		System.out.println(scores[2]);
		// System.out.println(scores[3]); // Exception in thread "main" java.lang.ArrayIndexOutOfBoundsException
