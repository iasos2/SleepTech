...
public class G_Operator {
	...
	public static void main(String[] args) {
		...
		System.out.println(21  / 10); // 나눗셈 (몫)	
		System.out.println(21  % 10); // 나눗셈 (나머지)
		...
		System.out.println(number++); // 10 : 출력 후 증가 1 + 10 (증가)
		System.out.println(number--); // 11 : 출력 후 감소 -1 + 10 (감소)
		System.out.println(number); // 10
