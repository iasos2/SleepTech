...
public class F_IO {
	...
	public static void main(String[] args) {
			...
			int height = scanner.nextInt(); // 자동으로 줄바꾸 처림 + 200 + \n
			...
			// - 처리방법
			//	: nextLine()의 입력 메서드 호출로 버퍼의 데이터를 처리(Enter 처리)
			...
			scanner.nextLine(); //Exception in thread "main" java.lang.IllegalStateException: Scanner closed
