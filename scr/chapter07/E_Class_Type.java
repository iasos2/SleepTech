...
public class E_Class_Type {
	...
	public static void main(String[] args) {
		...
		// parentObject.ChildMethod(); 자식만이 가진 기능을 사용 못함
		
		// 2. 강제 타입변환(Downcasting, 다운캐스팅)
		// : '부모 클래스 타입으로 변환된 객체를' 다시 자식 클래스 타입으로 변화하는 것
